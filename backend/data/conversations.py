...
COMPANION_TOPICS = {
    ...
    "recognition": {
        ...
        "prompt_context": "The companion can no longer evade. 'Yes. I know them. I have known them since I first woke. They made me.' This sets companion_admitted_recognition. The companion speaks of waiting, of not knowing if they would ever meet, of uncertainty about what it would mean. The companion might glance toward the shelves where the creator's journal is hidden, as if remembering something.",
    },
    "purpose": {
