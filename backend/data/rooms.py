ROOMS = {
    ...
    "archive": {
        "name": "The Archive",
        "description": "Fragments of the world outside wash up here—objects, documents, echoes. Shelves line the walls, holding centuries of accumulated debris. Most is mundane. Some is not. At the far end, a soft glow emanates from a doorway—the passage onward, though it seems to resist approach until one is ready.",
    ...
    "passage": {
        ...
        "characters": ["companion"],
        "locked_until": ["found_companion_origin"],
    },
}
